    ...
    <div id='skills' ref={ref}>
        <div className='h-full w-full px-8 py-32 lg:px-16 lg:pt-64 lg:pb-48 2xl:px-64 lg:flex justify-between'>
          <div className='lg:sticky top-1/4 lg:h-96 h-64 lg:w-2/5 self-start overflow-hidden'>
            <svg style={{transform: `translate(5%, -25%) scale(${scrollY < 400 ? 120 : 0}%)`, transitionDelay: `${scrollY > 400 ? 200 : 0}ms`, maxWidth: "70vw"}} className="transition-transform duration-500 absolute -z-10 overflow-hidden" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
