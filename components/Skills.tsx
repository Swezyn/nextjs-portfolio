        ...
        <div className='h-full w-full px-8 pt-16 pb-32 lg:px-16 lg:pt-64 lg:pb-48 2xl:px-64 lg:flex justify-between'>
          <div className='lg:sticky top-1/4 lg:h-96 h-64 lg:w-2/5 self-start overflow-hidden'>
            ...
            <div className='lg:translate-y-0 translate-y-8'>
              <h1 style={{transform: `translateY(${scrollY < 600 ? 0 : -250}%)`, transitionDelay: `${scrollY < 600 ? 100 : 0}ms`}} className='lg:text-7xl text-2xl font-bold text-neutral-900 leading-none transition-transform duration-500'>My most important skills</h1>
              <p style={{transform: `translateY(${scrollY < 600 ? 0 : -400}%)`}} className='leading-normal lg:text-2xl lg:mt-8 mt-4 transition-transform duration-500 delay-100'>These are my favorite tools and frameworks for <span className='font-semibold'>Web Development</span></p>
            </div>
          </div>
