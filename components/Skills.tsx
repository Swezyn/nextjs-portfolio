...
export default function Skills() {
  ...
  return (
    <div id='skills' ref={ref}>
        <div className='h-full w-full px-8 pt-16 pb-32 lg:px-16 lg:pt-64 lg:pb-48 2xl:px-64 lg:flex justify-between'>
          <div className='lg:sticky top-1/4 lg:h-96 h-64 lg:w-2/5 self-start overflow-hidden'>
            <svg className={`transition-transform duration-500 absolute -z-10 overflow-hidden -translate-y-32 lg:translate-x-8 -translate-x-4 ${scrollY < 400 ? "lg:scale-125 scale-100" : "scale-0 delay-200"}`} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
              <path className='fill-purple-400 opacity-30' d="M26.8,-39.8C38.8,-39.6,55.1,-40.4,57.3,-34C59.6,-27.5,47.8,-13.7,46.9,-0.5C46.1,12.8,56.4,25.6,54.5,32.7C52.6,39.8,38.5,41.1,27.4,39.5C16.3,37.8,8.2,33.2,-3.7,39.6C-15.5,45.9,-31,63.2,-44.7,66.3C-58.4,69.5,-70.3,58.5,-78.2,45C-86.2,31.6,-90.2,15.8,-87.9,1.3C-85.5,-13.1,-76.9,-26.2,-64.9,-32.7C-52.9,-39.1,-37.5,-38.7,-26.2,-39.2C-14.8,-39.7,-7.4,-41,0,-41.1C7.5,-41.1,14.9,-40,26.8,-39.8Z" transform="translate(100 100)" />
            </svg>
            <div className='lg:translate-y-0 translate-y-8'>
              <h1 style={{transform: `translateY(${scrollY < 400 ? 0 : -250}%)`, transitionDelay: `${scrollY < 400 ? 100 : 0}ms`}} className='lg:text-7xl text-2xl font-bold text-neutral-900 leading-none transition-transform duration-500'>My most important skills</h1>
              <p style={{transform: `translateY(${scrollY < 400 ? 0 : -400}%)`}} className='leading-normal lg:text-2xl lg:mt-8 mt-4 transition-transform duration-500 delay-100'>These are my favorite tools and frameworks for <span className='font-semibold'>Web Development</span></p>
            </div>
          </div>
    ...
    <div ref={ref} className='bg-neutral-100 h-fit rounded-xl flex flex-col items-center shadow-xl lg:p-16 p-8'>
      ...
      <div className='w-full lg:h-4 h-2 border-neutral-500 bg-neutral-400 border-2 rounded-full flex items-center'>
        <div style={{width: `${scrollY < 650 ? procent : 0}%`}} className='flex justify-end transition-all duration-500'>
          <div className='rounded-full lg:h-8 lg:w-8 h-4 w-4 bg-purple-400 border-neutral-500 border-2 translate-x-4'>
